      ...
      <div className="flex flex-wrap -m-2">
        <div className="p-2 w-1/2">
          <div className="relative">
            <label name="name" className="leading-7 text-sm text-gray-600">Name</label>
        ...
        <div className="p-2 w-full">
          <div className="relative">
            <label name="message" className="leading-7 text-sm text-gray-600">Message</label>
        ...
        <div className="p-2 w-full">
          <button className="flex mx-auto text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">Contact us</button>
        </div>
